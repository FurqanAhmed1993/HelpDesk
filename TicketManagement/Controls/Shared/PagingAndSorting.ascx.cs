    ...
    public partial class PagingAndSorting : System.Web.UI.UserControl
    {
        ...
        private void setPaginationLinks()
        {
            ...
            if (totalPages < 2)
            {
                ...
                imgNext.ImageUrl = "~/images/next_btn_ov.jpg";
                imgPrevious.ImageUrl = "~/images/previous_btn_ov.jpg";
            }
            else
            {
                ...
                if (totalPages == currentPage)
                {
                    ...
                    imgPrevious.ImageUrl = "~/images/previous_btn.jpg";
                }
                else if (currentPage == 1)
                {
                    ...
                    imgNext.ImageUrl = "~/images/next_btn.jpg";
                }
                else
                {
                    imgPrevious.Enabled = true;
