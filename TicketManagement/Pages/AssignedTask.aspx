<%@ Page Title="" Language="C#" MasterPageFile="~/Master/AdminMaster.master" AutoEventWireup="true" CodeFile="AssignedTask.aspx.cs" Inherits="Pages_AssignedTask" %>
        ...
        <div class="row-fluid ">
            <div class="span12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="/Pages/AssignedTask.aspx">Assigned Tasks  </a></li>
                </ul>
            </div>
        </div>
    ...
    <script type="text/javascript">
        ...
        function pageLoad() {
            ...
            $(".lnkbtnTaskDetail").click(function () {
                var url = "/pages/TaskDetail.aspx?IsInitiator=0&&IsView=1&&TMID=" + $(this).closest("tr").find(".hfTicketMasterIdRpt").val() + "&&hfTaskMasterId=" + $(this).closest("tr").find(".hfTaskMasterIdRpt").val() + "";
