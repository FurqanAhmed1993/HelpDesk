<%@ Page Title="" Language="C#" MasterPageFile="~/Master/AdminMaster.master" AutoEventWireup="true" CodeFile="Setup_RequestType.aspx.cs" Inherits="Pages_Setup_Setup_RequestType" %>
        ...
        <div class="row-fluid ">
            <div class="span12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="/Pages/Setup/Setup_RequestType.aspx">Request Type </a></li>
                </ul>
            </div>
        </div>
                        ...
                        <div class="widget-container">
                            <div class="controls-row">
                                ...
                                <div class="control-group span4">
                                    ...
                                    <div class="controls">
                                        <asp:TextBox runat="server" ID="txtRequestTypeSearch" PlaceHolder="Request Type " CssClass="span12 EnterEvent"></asp:TextBox>
                                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <%# Eval("RequestTypeName") %>
                                                        <input type="hidden" id="hfRId" value=' <%# Eval("RequestTypeId") %>' runat="server" />
                                                </td>
                                        ...
                                        <div class="widget-container">
                                            <div class="controls-row">
                                                ...
                                                <div class="control-group span6">
                                                    <label class="control-label">Request Type</label>
                                                    <div class="controls">
                                                        <asp:TextBox runat="server" ID="txtRequestType" PlaceHolder="Request Type" MaxLength="50" CssClass="span12 TextBoxValidate"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
