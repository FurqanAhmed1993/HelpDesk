<%@ Page Title="" Language="C#" MasterPageFile="~/Master/AdminMaster.master" AutoEventWireup="true" CodeFile="Setup_TicketLevel.aspx.cs" Inherits="Pages_Setup_Setup_TicketLevel" %>
        ...
        <div class="row-fluid ">
            <div class="span12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="/Pages/Setup/Setup_TicketLevel.aspx">Level </a></li>
                </ul>
            </div>
        </div>
                        ...
                        <div class="widget-container">
                            <div class="controls-row">
                                ...
                                <div class="control-group span4">
                                    ...
                                    <div class="controls">
                                        <asp:TextBox runat="server" ID="txtLevelSearch" PlaceHolder="Level " CssClass="span12 EnterEvent"></asp:TextBox>
                                    </div>
                                </div>
                                    ...
                                    <asp:Repeater ID="rpt" runat="server">
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td>
                                                      <input type="hidden" id="hfRId" value=' <%# Eval("LevelId") %>' runat="server" />
                                                    <%# Eval("Level") %>
                                                </td>
                                        ...
                                        <div class="widget-container">
                                            <div class="controls-row">
                                                ...
                                                <div class="control-group span6">
                                                    <label class="control-label">Level</label>
                                                    <div class="controls">
                                                        <asp:TextBox runat="server" ID="txtLevel" PlaceHolder="Level" MaxLength="50" CssClass="span12 TextBoxValidate"></asp:TextBox>
                                                    </div>
                                                </div>
