<%@ Page Title="" Language="C#" MasterPageFile="~/Master/AdminMaster.master" AutoEventWireup="true" CodeFile="Setup_TicketType.aspx.cs" Inherits="Pages_Setup_Setup_TicketType" %>
        ...
        <div class="row-fluid ">
            <div class="span12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="/Pages/Setup/Setup_TicketType.aspx">Ticket Type </a></li>
                </ul>
            </div>
        </div>
                        ...
                        <div class="widget-container">
                            <div class="controls-row">
                                ...
                                <div class="control-group span4">
                                    ...
                                    <div class="controls">
                                        <asp:TextBox runat="server" ID="txtTicketTypeSearch" PlaceHolder="Ticket Type" CssClass="span12 EnterEvent"></asp:TextBox>
                                    </div>
                                </div>
                                    ...
                                    <asp:Repeater ID="rpt" runat="server">
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td>
                                                     <input type="hidden" id="hfRId" value=' <%# Eval("TicketTypeId") %>' runat="server" />
                                                    <%# Eval("TicketTypeName") %>
                                                </td>
                                        ...
                                        <div class="widget-container">
                                            <div class="controls-row">
                                                ...
                                                <div class="control-group span6">
                                                    <label class="control-label">Ticket Type</label>
                                                    <div class="controls">
                                                        <asp:TextBox runat="server" ID="txtTicketType" PlaceHolder="Ticket Type" MaxLength="50" CssClass="span12 TextBoxValidate"></asp:TextBox>
                                                    </div>
                                                </div>
