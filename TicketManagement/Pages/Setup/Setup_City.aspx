<%@ Page Title="" Language="C#" MasterPageFile="~/Master/AdminMaster.master" AutoEventWireup="true" CodeFile="Setup_City.aspx.cs" Inherits="Pages_Setup_Setup_City" %>
        ...
        <div class="row-fluid ">
            <div class="span12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">City Setup<span class="divider"><i class="icon-angle-right"></i></span></li>
                    <li><a href="/Pages/Setup/Setup_City.aspx">City</a></li>
                </ul>
            </div>
        </div>
                        ...
                        <div class="widget-container">
                            <div class="controls-row">
                                <div class="control-group span4">
                                    ...
                                    <div class="controls">
                                        <asp:TextBox runat="server" ID="txtCityNameSearch" PlaceHolder="City" CssClass="span12 EnterEvent"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="controls-row">
                                ...
                                <tbody>
                                    <asp:Repeater ID="rpt" runat="server">
                                        <ItemTemplate>
                                            <tr>
                                                <td>
                                                    <input type="hidden" id="hfRId" value=' <%# Eval("CityId") %>' runat="server" />
                                                    <%# Eval("CityName") %>
                                                </td>
                                        ...
                                        <div class="widget-container">
                                            <div class="controls-row">
                                                <div class="control-group span6">
                                                    ...
                                                    <div class="controls">
                                                        <asp:TextBox runat="server" ID="txtCityName" PlaceHolder="City Name" MaxLength="50" CssClass="span12 TextBoxValidate"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
