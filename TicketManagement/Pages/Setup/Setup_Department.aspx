<%@ Page Title="" Language="C#" MasterPageFile="~/Master/AdminMaster.master" AutoEventWireup="true" CodeFile="Setup_Department.aspx.cs" Inherits="Pages_Setup_Setup_Department" %>
        ...
        <div class="row-fluid ">
            <div class="span12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="/Pages/Setup/Setup_Department.aspx">Department </a></li>
                </ul>
            </div>
        </div>
                        ...
                        <div class="widget-container">
                            <div class="controls-row">
                                ...
                                <div class="control-group span4">
                                    ...
                                    <div class="controls">
                                        <asp:TextBox runat="server" ID="txtDepartmentSearch" PlaceHolder="Department " CssClass="span12 EnterEvent"></asp:TextBox>
                                    </div>
                                ...
                                <div class="control-group span4">
                                    ...
                                    <div class="controls">
                                        <asp:TextBox runat="server" ID="txtPrefixSearch" PlaceHolder="Prefix" CssClass="span12"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                                ...
                                <tbody>
                                    <asp:Repeater ID="rpt" runat="server" OnItemDataBound="rpt_ItemDataBound">
                                        <ItemTemplate>
                                            <tr>
                                                <td>
                                                    <input type="hidden" id="hfRId" value=' <%# Eval("DepartmentId") %>' runat="server" />
                                                    <input type="hidden" id="hfIsDefault" value=' <%# Eval("IsDefault") %>' runat="server" />
                                                    <%# Eval("DepartmentName") %>
                                                </td>
                                                <td>
                                                    <%# Eval("DepartmentPrefix") %>
                                                </td>
                                                <td>
                                                    <%# Eval("Email") %>
                                                </td>
                                        ...
                                        <div class="widget-container">
                                            <div class="controls-row">
                                                ...
                                                <div class="control-group span6">
                                                    <label class="control-label">Department</label>
                                                    <div class="controls">
                                                        <asp:TextBox runat="server" ID="txtDepartment" PlaceHolder="Department" MaxLength="50" CssClass="span12 TextBoxValidate"></asp:TextBox>
                                                    </div>
                                                </div>
                                                <div class="control-group span6">
                                                    <label class="control-label">Prefix</label>
                                                    <div class="controls">
                                                        <asp:TextBox runat="server" ID="txtPrefix" PlaceHolder="Prefix" MaxLength="50" CssClass="span12 TextBoxValidate"></asp:TextBox>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="controls-row">
                                                <div class="control-group span6">
                                                    ...
                                                    <div class="controls">
                                                        <asp:TextBox runat="server" ID="txtEmailId" PlaceHolder="Email Id" MaxLength="50" TextMode="Email" CssClass="span12 "></asp:TextBox>
                                                    </div>
                                                </div>
                                                <div class="control-group span6">
                                                    <label class="control-label">Description</label>
                                                    <div class="controls">
                                                        <asp:TextBox runat="server" ID="txtDescription" PlaceHolder="Description" MaxLength="100" CssClass="span12"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <%--    <div class="controls-row">
                                                <div class="control-group span6">
                                                    ...
                                                    <div class="controls">
                                                      <asp:CheckBox runat="server" ID="isDefault" Checked="false" />
                                                    </div>
                                                </div>
                                            </div>--%>
