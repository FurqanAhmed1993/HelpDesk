<%@ Page Title="" Language="C#" MasterPageFile="~/Master/AdminMaster.master" AutoEventWireup="true" CodeFile="Setup_TypeOfIssue.aspx.cs" Inherits="Pages_Setup_Setup_TypeOfIssue" %>
        ...
        <div class="row-fluid ">
            <div class="span12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="/Pages/Setup/Setup_TypeOfIssue.aspx">Product</a></li>
                </ul>
            </div>
        </div>
                        ...
                        <div class="widget-container">
                            <div class="controls-row">
                                <div class="control-group span4">
                                    ...
                                    <div class="controls">
                                        <asp:TextBox runat="server" ID="txtProductSearch" PlaceHolder="Product" CssClass="span12 EnterEvent" autocomplete="off"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                                ...
                                <tbody>
                                    <asp:Repeater ID="rpt" runat="server" OnItemCommand="rpt_ItemCommand">
                                        <ItemTemplate>
                                            <tr>
                                                <td>
                                                    <asp:Label ID="lblTypeOfIssue" Text='<%# Eval("TypeOfIssue") %>' runat="server" />
                                                </td>

                                                <td class="project-actions" style="text-align: center;">
                                                    <asp:LinkButton ID="lbEdit"
                                                        runat="server" CssClass="btn btn-primary"
                                                        CommandName="Edit" CommandArgument='<%# Eval("TypeOfIssueId") %>'><span aria-hidden="true" class="fa fa-edit"></span>Edit
                                                    </asp:LinkButton>
                                                    <asp:LinkButton ID="lbDelete" runat="server" CssClass="btn btn-danger"
                                                        ...
                                                        CommandName="Delete" CommandArgument='<%# Eval("TypeOfIssueId") %>'><span aria-hidden="true" class="fa fa-trash"></span>Delete
                                                    </asp:LinkButton>
                                                </td>
                                        ...
                                        <div class="widget-container">
                                            <div class="controls-row">
                                                ...
                                                <div class="control-group span6">
                                                    <label class="control-label">Product</label>
                                                    <div class="controls">
                                                        <asp:TextBox runat="server" ID="txtProduct" PlaceHolder="Product" MaxLength="50" CssClass="span12 TextBoxValidate" autocomplete="off"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
