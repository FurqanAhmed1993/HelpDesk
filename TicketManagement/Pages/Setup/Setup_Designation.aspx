<%@ Page Title="" Language="C#" MasterPageFile="~/Master/AdminMaster.master" AutoEventWireup="true" CodeFile="Setup_Designation.aspx.cs" Inherits="Pages_Setup_Setup_Designation" %>
        ...
        <div class="row-fluid ">
            <div class="span12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="/Pages/Setup/Setup_Designation.aspx">Designation </a></li>
                </ul>
            </div>
        </div>
                        ...
                        <div class="widget-container">
                            <div class="controls-row">
                                ...
                                <div class="control-group span4">
                                    ...
                                    <div class="controls">
                                        <asp:TextBox runat="server" ID="txtDesignationSearch" PlaceHolder="Designation" CssClass="span12 EnterEvent"></asp:TextBox>
                                    </div>
                                </div>
                                    ...
                                    <asp:Repeater ID="rpt" runat="server">
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="hidden" id="hfRId" value=' <%# Eval("DesignationId") %>' runat="server" />
                                        ...
                                        <div class="widget-container">
                                            <div class="controls-row">
                                                ...
                                                <div class="control-group span6">
                                                    <label class="control-label">Designation</label>
                                                    <div class="controls">
                                                        <asp:TextBox runat="server" ID="txtDesignation" PlaceHolder="Designation" MaxLength="50" CssClass="span12 TextBoxValidate"></asp:TextBox>
                                                    </div>
                                                </div>
