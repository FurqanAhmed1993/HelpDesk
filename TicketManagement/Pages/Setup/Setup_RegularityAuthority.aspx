<%@ Page Title="" Language="C#" MasterPageFile="~/Master/AdminMaster.master" AutoEventWireup="true" CodeFile="Setup_RegularityAuthority.aspx.cs" Inherits="Pages_Setup_Setup_RegularityAuthority" %>
        ...
        <div class="row-fluid ">
            <div class="span12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="/Pages/Setup/Setup_RegularityAuthority.aspx">Regularity Authority </a></li>
                </ul>
            </div>
        </div>
                        ...
                        <div class="widget-container">
                            <div class="controls-row">
                                ...
                                <div class="control-group span4">
                                    <label class="control-label">Regularity Authority</label>


                                    <div class="controls">
                                        <asp:TextBox runat="server" ID="txtAuthoritySearch" PlaceHolder="Regularity Authority" CssClass="span12 EnterEvent"></asp:TextBox>
                                    </div>
                                ...
                                <tbody>
                                    <asp:Repeater ID="rpt" runat="server">
                                        <ItemTemplate>
                                            <tr>
                                                <td>
                                                    <input type="hidden" id="hfRId" value=' <%# Eval("Id") %>' runat="server" />
                        ...
                        <div class="row-fluid">
                            <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                <ContentTemplate>
                                    ...
                                    <div class="content-widgets light-gray">
                                        <div class="widget-head bluePSW">
                                            <h3>Add /Edit  Regularity Authority</h3>
                                        </div>
                                        <div class="widget-container">
                                            <div class="controls-row">
                                                <div class="control-group span6">
                                                    <label class="control-label">Regularity Authority</label>
                                                    <div class="controls">
                                                        <asp:TextBox runat="server" ID="txtRegAuthority" PlaceHolder="Regularity Authority" MaxLength="50" CssClass="span12 TextBoxValidate"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
