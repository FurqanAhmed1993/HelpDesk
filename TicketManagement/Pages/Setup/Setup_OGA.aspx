<%@ Page Title="" Language="C#" MasterPageFile="~/Master/AdminMaster.master" AutoEventWireup="true" CodeFile="Setup_OGA.aspx.cs" Inherits="Pages_Setup_Setup_OGA" %>
        ...
        <div class="row-fluid ">
            <div class="span12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="/Pages/Setup/Setup_OGA.aspx">OGA </a></li>
                </ul>
            </div>
        </div>
                        ...
                        <div class="widget-container">
                            <div class="controls-row">
                                ...
                                <div class="control-group span4">
                                    <label class="control-label">OGA</label>


                                    <div class="controls">
                                        <asp:TextBox runat="server" ID="txtOGASearch" PlaceHolder="OGA" CssClass="span12 EnterEvent"></asp:TextBox>
                                    </div>
                                        ...
                                        <div class="widget-container">
                                            <div class="controls-row">
                                                <div class="control-group span6">
                                                    <label class="control-label">OGA</label>
                                                    <div class="controls">
                                                        <asp:TextBox runat="server" ID="txtOGA" PlaceHolder="OGA" MaxLength="50" CssClass="span12 TextBoxValidate"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
