<%@ Page Title="" Language="C#" MasterPageFile="~/Master/AdminMaster.master" AutoEventWireup="true" CodeFile="Setup_ReportedBy.aspx.cs" Inherits="Pages_Setup_Setup_ReportedBy" %>
        ...
        <div class="row-fluid ">
            <div class="span12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">ReportedBy Setup<span class="divider"><i class="icon-angle-right"></i></span></li>
                    <li><a href="/Pages/Setup/Setup_ReportedBy.aspx">ReportedBy</a></li>
                </ul>
            </div>
        </div>
                        ...
                        <div class="widget-container">
                            <div class="controls-row">
                                <div class="control-group span4">
                                    <label class="control-label">ReportedBy</label>
                                    <div class="controls">
                                        <asp:TextBox runat="server" ID="txtReportedBySearch" PlaceHolder="ReportedBy Name" CssClass="span12 EnterEvent"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="controls-row">
                                ...
                                <tbody>
                                    <asp:Repeater ID="rpt" runat="server">
                                        <ItemTemplate>
                                            <tr>
                                                <td>
                                                    <input type="hidden" id="hfRId" value=' <%# Eval("ReportedById") %>' runat="server" />
                                                    <%# Eval("ReportedByName") %>
                                                </td>
                        ...
                        <div class="row-fluid">
                            ...
                            <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                <ContentTemplate>
                                    ...
                                    <div class="content-widgets light-gray">
                                        <div class="widget-head bluePSW">
                                            <h3>Add / Edit ReportedBy</h3>
                                        </div>
                                        <div class="widget-container">
                                            <div class="controls-row">
                                                <div class="control-group span6">
                                                    <label class="control-label">ReportedBy Name</label>
                                                    <div class="controls">
                                                        <asp:TextBox runat="server" ID="txtReportedByName" PlaceHolder="ReportedBy Name" MaxLength="50" CssClass="span12 TextBoxValidate"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
