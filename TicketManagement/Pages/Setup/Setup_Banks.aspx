<%@ Page Title="" Language="C#" MasterPageFile="~/Master/AdminMaster.master" AutoEventWireup="true" CodeFile="Setup_Banks.aspx.cs" Inherits="Pages_Setup_Setup_Banks" %>
        ...
        <div class="row-fluid ">
            <div class="span12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="/Pages/Setup/Setup_Banks.aspx">Bank </a></li>
                </ul>
            </div>
        </div>
                        ...
                        <div class="widget-container">
                            <div class="controls-row">
                                ...
                                <div class="control-group span4">
                                    ...
                                    <div class="controls">
                                        <asp:TextBox runat="server" ID="txtBankSearch" PlaceHolder="Bank Name " CssClass="span12 EnterEvent"></asp:TextBox>
                                    </div>
                                ...
                                <tbody>
                                    <asp:Repeater ID="rpt" runat="server">
                                        <ItemTemplate>
                                            <tr>
                                                <td>
                                                    <input type="hidden" id="hfRId" value=' <%# Eval("BankId") %>' runat="server" />
                                        ...
                                        <div class="widget-container">
                                            <div class="controls-row">
                                                <div class="control-group span6">
                                                    <label class="control-label">Bank</label>
                                                    <div class="controls">
                                                        <asp:TextBox runat="server" ID="txtBank" PlaceHolder="Bank" MaxLength="50" CssClass="span12 TextBoxValidate"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
