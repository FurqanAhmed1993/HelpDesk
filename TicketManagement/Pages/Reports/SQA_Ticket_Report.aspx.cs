...
using System.Data;
public partial class Pages_Reports_SQA_Ticket_Report : Base
{
    ...
    private void BindDropdown()
    {
        try
        {
            ...
            var liStatus = context.TS_Setup_TicketStatus.Where(a => a.IsActive == true && a.StatusId != (int)Constant.TicketStatus.New).OrderBy(b => b.Status).ToList();
            ...
            Common.BindDropDown(ddlCategory, dt, "Name", "Id", false, false);
            Common.BindDropDown(ddlSubcategory, dt, "Name", "Id", false, false);
    ...
    protected void ddlRequestType_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            var category = context.TS_Setup_RequestTypeCategory.Where(x => x.IsActive == true && x.RequestTypeId == requestTypeId).ToList();
    ...
    protected void btn_Export_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=SQA_Ticket_Report.xls");
    ...
    private void BindRepeater()
    {
        try
        {
            ...
            //SqlDataAdapter da = new SqlDataAdapter("RPT_SQA_Report", con);
            SqlDataAdapter da = new SqlDataAdapter("RPT_SQA_Report_NEW", con);
            ...
            da.SelectCommand.Parameters.Add("@RequestTypeCategoryId", SqlDbType.Int).Value = RequestTypeCategoryId_;
            da.SelectCommand.Parameters.Add("@RequestTypeSubcategoryId", SqlDbType.Int).Value = RequestTypeSubcategoryId_;
            da.SelectCommand.Parameters.Add("@TicketNo", SqlDbType.NVarChar).Value = TicketNo;
