...
public partial class Pages_AssignedTask : Base
{
    ...
    private void BindDropdown()
    {
        ...
        {
            var List = context.UserLogins.Where(x => x.Is_Active == true && (x.User_Code == UserId || IsSuperAdmin || IsAdmin))
    ...
    private void BindRepeater()
    {
        try
        {
            ...
            if (ddlAssigneeSearch.SelectedIndex != -1)
                AssigneeId = Convert.ToInt32(ddlAssigneeSearch.SelectedItem.Value);
            ...
            var List = context.TS_TaskMaster.Where(e => e.IsActive == true
                  && (e.TS_TicketMaster.TicketCode.Contains(TicketNo) || TicketNo == string.Empty)
                    ...
                    && (e.AssigneeId == AssigneeId || AssigneeId == 0)
                    && ((e.DepartmentId == DepartmentId && e.AssigneeId.HasValue == false || ListUnderEmployee.Contains(e.AssigneeId)) || ListUnderEmployee.Contains(e.AssigneeId) || e.AssigneeId == UserId || IsAdmin == true || IsSuperAdmin == true)
                ).Select(c => new
                {
    ...
    protected void btn_Cancel_Click(object sender, EventArgs e)
    {
        txtTicketNo.Text = "";
        txtTitle.Text = "";
        ddlAssigneeSearch.SelectedValue = "0";
